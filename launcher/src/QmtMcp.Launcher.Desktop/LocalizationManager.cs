...
internal sealed class LocalizationManager
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        ["PlaceholderXtquant"] = "Directory containing xtquant",
        ...
        ["PickerXtquant"] = "Select directory containing xtquant",
        ...
        ["ResolutionXtquantMissing"] = "No xtquant was found in the selected QMT tree or local SDK directory. Browse to its import root.",
    ...
    private static readonly IReadOnlyDictionary<string, string> ChineseStrings = new Dictionary<string, string>
    {
        ...
        ["PlaceholderXtquant"] = "包含 xtquant 的目录",
        ...
        ["PickerXtquant"] = "选择包含 xtquant 的目录",
        ...
        ["ResolutionXtquantMissing"] = "所选 QMT 目录和本地 SDK 目录中均未找到 xtquant，请浏览选择其导入根目录。",
